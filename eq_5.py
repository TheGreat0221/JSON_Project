...
in_file_2020 = open('MODIS_C6_Australia_NewZealand_MCD14DL_NRT_2020026.txt','r')

eq_csv = csv.reader(in_file_2020, delimiter=",")
...
offline.plot(fig,filename='Austrialian_Fires_2020.html')
